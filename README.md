 ...
 * Cмена знака числа осуществляется вводом "Underscore": Shift + '-'
...
* Ускорен алгоритм факторизации целого числа благодаря использованию теста 
простоты Миллера-Рабина, и комбинированию "ро" и (p-1) методов Полларда, а также 
метода Ферма.
...
### Версия 1.08, 01.03.2025

Рефакторинг:

* Библиотеки U128 и сопутствующих,
* Инициализации приложения,
* Логирование результатов.

### Версия 1.09, 16.09.2025
